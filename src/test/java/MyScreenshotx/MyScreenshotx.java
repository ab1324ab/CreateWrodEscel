...
import MyScreenshotx.filter.BMPfilter;
import MyScreenshotx.filter.GIFfilter;
import MyScreenshotx.filter.JPGfilter;
import MyScreenshotx.filter.PNGfilter;
...
//        System.out.println("topLeft");
    ...
    public void boxWrite(Graphics g) {
        ...
        for (List<Object> array : boxArr) {
            int boxStartX = Integer.parseInt(array.get(0) + "");// .getInt(0);
    ...
    public static void main(String[] args) {
        ...
        MyScreenshotx screenTest = new MyScreenshotx(jFrame);
